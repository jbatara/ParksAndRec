    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
      builder.Entity<Park>()
          .HasData(
              ...
              new Park { ParkId = 3, Name = "Eagleton Park", DepartmentId = 3 },
              new Park { ParkId = 4, Name = "Maplewood Park", DepartmentId = 2 },
              new Park { ParkId = 5, Name = "North Pawnee Recreation Center", DepartmentId = 2 },
              new Park { ParkId = 6, Name = "Wamapokestone Park", DepartmentId = 2 },
              new Park { ParkId = 7, Name = "Tucker Park", DepartmentId = 2 },
              new Park { ParkId = 8, Name = "Pawnee Park: Smallest Park in Indiana", DepartmentId = 2 },
              new Park { ParkId = 9, Name = "Slippery Elm Park", DepartmentId = 2 },
              new Park { ParkId = 10, Name = "Ramsett Park", DepartmentId = 2 }
          );
